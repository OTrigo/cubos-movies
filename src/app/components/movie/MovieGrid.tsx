...
const MovieGrid = ({ movies }: { movies?: Movie[] }) => {
  return (
    <div className="grid md:min-w-1/2 w-full grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 h-full p-6 bg-[#EBEAF814] z-10 md:w-fit md:min-h-[600px] backdrop-blur-[4px] overflow-hidden">
      {movies?.length === 0 && (
