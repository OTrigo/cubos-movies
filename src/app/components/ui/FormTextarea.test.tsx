...
describe("FormTextarea", () => {
  ...
  test("aplica as classes CSS corretamente ao textarea", () => {
    ...
    expect(textarea).toHaveClass("bg-[#1a191b]");
  ...
  test("permite interação com o textarea", () => {
    ...
    const textarea = screen.getByRole("textbox");
    fireEvent.change(textarea, { target: { value: "Este é um exemplo de texto para teste" } });
  ...
  test("manipula eventos corretamente", () => {
    ...
    render(<FormTextarea label="Descrição" name="description" onChange={handleChange} />);
