...
describe("Footer", () => {
  ...
  test("exibe o texto de copyright correto", () => {
    ...
    expect(screen.getByText("2025 © Todos os direitos reservados a Cubos Movies")).toBeInTheDocument();
  });
  ...
  test("aplica as classes CSS corretas ao elemento footer", () => {
    ...
    expect(footer).toHaveClass("bg-[#121113]");
  ...
  test("aplica a classe de cor de texto correta ao texto de copyright", () => {
    ...
    const textElement = screen.getByText("2025 © Todos os direitos reservados a Cubos Movies");
